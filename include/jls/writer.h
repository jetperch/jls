...
int32_t jls_wr_signal_f32(struct jls_wr_s * self, uint16_t signal_id, uint32_t size, const float * data);
...
int32_t jls_wr_ts_f32(struct jls_wr_s * self, uint16_t ts_id, int64_t timestamp, uint32_t size, const char * txt);
